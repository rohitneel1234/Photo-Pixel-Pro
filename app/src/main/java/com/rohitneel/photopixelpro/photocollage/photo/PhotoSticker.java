...
public class PhotoSticker extends Sticker {
    ...
    public PhotoSticker(Context paramContext, int paramInt, Drawable paramDrawable) {
    ...
    @NonNull
    public PhotoSticker setAlpha(@IntRange(from = 0L, to = 255L) int paramInt) {
        this.drawable.setAlpha(paramInt);
        return this;
    }

    public PhotoSticker setDrawable(@NonNull Drawable paramDrawable) {
        return this;
    }
