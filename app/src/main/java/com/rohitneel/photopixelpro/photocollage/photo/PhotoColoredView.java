...
public class PhotoColoredView extends ImageView {
    ...
    public PhotoColoredView(Context context) {
        super(context);
        init();
    }

    public PhotoColoredView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public PhotoColoredView(Context context, AttributeSet attributeSet, int i) {
