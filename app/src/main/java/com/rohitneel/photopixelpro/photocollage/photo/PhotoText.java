...
public class PhotoText {
    ...
    public static PhotoText getDefaultProperties() {
        PhotoText photoText = new PhotoText();
        photoText.setTextSize(30);
        photoText.setTextAlign(4);
        photoText.setFontName("36.ttf");
        photoText.setTextColor(-1);
        photoText.setTextAlpha(255);
        photoText.setBackgroundAlpha(255);
        photoText.setPaddingWidth(12);
        photoText.setTextShaderIndex(7);
        photoText.setBackgroundColorIndex(21);
        photoText.setTextColorIndex(16);
        photoText.setFontIndex(0);
        photoText.setShowBackground(false);
        photoText.setBackgroundBorder(8);
        photoText.setTextAlign(4);
        return photoText;
    }
