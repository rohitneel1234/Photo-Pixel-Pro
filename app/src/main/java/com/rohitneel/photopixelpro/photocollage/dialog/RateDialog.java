package com.rohitneel.photopixelpro.photocollage.dialog;
...
public class RateDialog extends Dialog implements View.OnClickListener {
    ...
    private void initView() {
        ...
        this.text_view_cancel = findViewById(R.id.text_view_cancel);
        ...
        this.text_view_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
